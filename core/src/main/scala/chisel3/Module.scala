...
package experimental {
  ...
  abstract class BaseModule extends HasId with IsInstantiable with ReflectSelectable {
    ...
    /** Return true if this module has any port associations. */
    private[chisel3] def hasAsssociations: Boolean = _associations.nonEmpty
    ...
    */
    ...
    /** Return the layers for this module after.
      ...
      */
    private[chisel3] def _moduleLayers: Seq[Layer] = {
